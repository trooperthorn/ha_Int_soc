...
| RFC 5424 SIEM export over TLS/TCP/UDP, queue/drop status | AU-4, AU-5, AU-6, AU-9; SC-8, SC-23 | CC6.6, CC7.2-CC7.4 | Implemented, disabled by default; configure receiver/alerts and prefer verified TLS |
...
| Config change audit, safe defaults, versioned store | CM-2, CM-3, CM-5, CM-6, CM-8 | CC8.1 | Partial; require protected branch, approvals, deployment records |
...
| Tests, dependency/static scans, pinned CI actions, disclosure policy | SA-11, SI-2, SI-7, SR-3, SR-4, SR-5, SR-6 | CC8.1, CC9.1, CC9.2 | Improved; add SBOM, signing/provenance and release approval |
...
2. Enable branch protection with required Test, Validate, and Security checks,
   owner review, signed commits/releases, immutable tags, SBOM and provenance.
...
4. Generate a signed periodic evidence pack: user/MFA/access state, audit-chain

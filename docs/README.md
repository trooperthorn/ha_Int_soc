...
- `design.md`: architecture and rationale by subsystem (audit chain, store and secrets, WebSocket API and access control, detections and risk, scanner and provenance, health and hygiene, dashboard file editing, network integrations, probe and firewall, frontend, CI and release, tests). Why a thing is built the way it is.

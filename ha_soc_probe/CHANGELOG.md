...
- Future releases are staged as drafts with all assets attached before
  publication so GitHub release immutability can lock their tags and assets.
  The already-published `v2026.09.01.2` remains checksum- and
  attestation-verifiable but predates repository release immutability.

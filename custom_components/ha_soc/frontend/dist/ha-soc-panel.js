...
`,Tt={order:[],hidden:[]};function Nt(t,e){const s=new Map(t.map(t=>[t.id,t])),i=new Set,a=[];for(const t of e.order){const e=s.get(t);e&&!i.has(t)&&(a.push(e),i.add(t))}for(const e of t)i.has(e.id)||(a.push(e),i.add(e.id));return a}let Lt=class extends nt{constructor(){super(...arguments),this.sections=[],this.layout=Tt,this.editMode=!1,this._dragId=null}render(){const t=Nt(this.sections,this.layout),e=new Set(this.layout.hidden);return this.editMode?B`
  ...
  `,t([pt({attribute:!1})],Lt.prototype,"sections",void 0),t([pt({attribute:!1})],Lt.prototype,"layout",void 0),t([pt({type:Boolean})],Lt.prototype,"editMode",void 0),Lt=t([dt("ha-soc-customize-list")],Lt);class Ot extends nt{constructor(){super(...arguments),this.customizeMode=!1,this._layout=Tt,this._onLayoutChange=t=>{var e,s,i;this._layout=t.detail,(e=this.hass,s=this.viewId,i=t.detail,_t(e,{type:"ha_soc/layout/set",view_id:s,order:i.order,hidden:i.hidden})).catch(()=>{})}}connectedCallback(){super.connectedCallback(),this._loadLayout()}async _loadLayout(){try{this._layout=await(t=this.hass,e=this.viewId,_t(t,{type:"ha_soc/layout/get",view_id:e}))}catch{this._layout=Tt}var t,e}_renderSections(t){return B`

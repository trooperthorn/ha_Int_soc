...
${t.exception}</pre
    ...
    `}};qt.styles=St,t([pt({attribute:!1})],qt.prototype,"hass",void 0),t([ut()],qt.prototype,"_settings",void 0),t([ut()],qt.prototype,"_loading",void 0),qt=t([dt("ha-soc-settings-view")],qt);const Kt=[{id:"dashboard",label:"Dashboard"},{id:"entity_remap",label:"Entity ReMap"},{id:"users",label:"Users & Access"},{id:"permissions",label:"Permissions"},{id:"audit",label:"Audit Log"},{id:"peripherals",label:"Local Peripherals"},{id:"scanner",label:"Scanner"},{id:"logs",label:"Logs"},{id:"settings",label:"Settings"}];let Wt=class extends rt{constructor(){super(...arguments),this._tab="dashboard",this._access=null}connectedCallback(){super.connectedCallback(),this._loadAccess()}async _loadAccess(){try{this._access=await(t=this.hass,vt(t,{type:"ha_soc/access/info"}))}catch{this._access={is_owner:!1,access_level:"owner_only",allowed:!1}}var t}render(){return null===this._access?j`<div class="header">🛡️ HA SOC</div>`:this._access.allowed?j`

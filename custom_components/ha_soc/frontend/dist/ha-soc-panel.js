      ...
      <div class="card">
        ...
        <div class="toolbar">
          <select @change=${this._onCategoryChange}>
            ${Nt.map(t=>B`<option value=${t} ?selected=${t===this._category}>${t||"All categories"}</option>`)}
          </select>

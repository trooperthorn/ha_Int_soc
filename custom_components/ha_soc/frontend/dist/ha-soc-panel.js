 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}const _t=(t,e)=>t.callWS(e),gt=t=>_t(t,{type:"ha_soc/users/list"}).then(t=>t.users),vt=t=>_t(t,{type:"ha_soc/risk/list"}).then(t=>t.risk),mt=(t,e)=>_t(t,{type:"ha_soc/detections/list",status:e}).then(t=>t.detections),yt=(t,e,s)=>_t(t,{type:"ha_soc/detections/set_status",detection_id:e,status:s}),ft=t=>_t(t,{type:"ha_soc/vulns/list"}).then(t=>t.findings),bt=t=>_t(t,{type:"ha_soc/logs/fault"}),$t=t=>_t(t,{type:"ha_soc/logs/targets"}),wt=t=>_t(t,{type:"ha_soc/health/list"}),xt=t=>_t(t,{type:"ha_soc/dashboard/devices"}),kt=t=>_t(t,{type:"ha_soc/dashboard/integrations"}),St=t=>_t(t,{type:"ha_soc/access/info"}),At=t=>_t(t,{type:"ha_soc/probe/status"}),Ct=t=>_t(t,{type:"ha_soc/firewall/status"}),Pt=t=>_t(t,{type:"ha_soc/peripherals/list"}),Rt=t=>_t(t,{type:"ha_soc/entity_remap/broken_references"}).then(t=>t.broken),Et=t=>_t(t,{type:"ha_soc/security_health/list"}),zt=o`
  :host {
    display: block;
    padding: 16px;
    max-width: 1400px;
...
`;function Ft(t,e,s){if(!e)return t;const i=s[e.key];return i?t.map((t,e)=>({row:t,i:e})).sort((t,s)=>{const a=i(t.row),n=i(s.row),o=null==a||""===a,r=null==n||""===n;if(o&&r)return t.i-s.i;if(o)return 1;if(r)return-1;let l;return l="number"==typeof a&&"number"==typeof n?a-n:"boolean"==typeof a&&"boolean"==typeof n?Number(a)-Number(n):String(a).localeCompare(String(n),void 0,{sensitivity:"base",numeric:!0}),0!==l?l*e.dir:t.i-s.i}).map(t=>t.row):t}function It(t,e,s,i,a={}){const n=s?.key===e,o=n?1===s.dir?"ascending":"descending":"none",r=n?1===s.dir?"▲":"▼":"⇅";return B`
  ...
  `}let Ot=class extends rt{constructor(){super(...arguments),this._users=[],this._risk={},this._loading=!0,this._busyUserId=null,this._sort=null,this._isOwner=!1}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{const[t,e,s]=await Promise.all([gt(this.hass),vt(this.hass),St(this.hass).catch(()=>({is_owner:!1}))]);this._users=t,this._risk=e,this._isOwner=!!s.is_owner}finally{this._loading=!1}}_adminTargetLocked(t){return!this._isOwner&&(t.is_owner||t.groups.includes("system-admin"))}_fmtDate(t){if(!t)return"never";return new Date(t).toLocaleString()}async _onDeactivate(t){if(confirm("Deactivate this user? All their sessions will be revoked.")){this._busyUserId=t;try{await((t,e)=>_t(t,{type:"ha_soc/users/deactivate",user_id:e}))(this.hass,t),await this._load()}finally{this._busyUserId=null}}}async _onRevokeAll(t){if(confirm("Revoke every interactive session for this user? Long-lived tokens are kept.")){this._busyUserId=t;try{await((t,e)=>_t(t,{type:"ha_soc/users/revoke_all_sessions",user_id:e}))(this.hass,t),await this._load()}finally{this._busyUserId=null}}}async _onResetPassword(t){const e=prompt("New password for this user (owner-only action):");if(e){this._busyUserId=t;try{const s=await((t,e,s)=>_t(t,{type:"ha_soc/users/set_password",user_id:e,password:s}))(this.hass,t,e);s&&!1===s.ok&&alert("Could not set password — only the account owner can reset another user's password.")}finally{this._busyUserId=null}}}render(){if(this._loading)return B`<div class="empty">Loading users…</div>`;if(!this._users.length)return B`<div class="empty">No users found.</div>`;const t=this._sort,e=t=>{this._sort=t},s=Ft(this._users,t,{user:t=>t.name??t.id,role:t=>`${t.is_admin?"Admin":"User"}${t.local_only?" · local only":""}`,mfa:t=>t.mfa_enabled,risk:t=>this._risk[t.id]?.score??null,last_login:t=>t.last_login_at?Date.parse(t.last_login_at):null,tokens:t=>t.llat_count});return B`
        ...
        <table>
          <thead>
            <tr>
              ...
              ${It("MFA","mfa",t,e)}
              ${It("Risk","risk",t,e)}
              ${It("Last login","last_login",t,e)}
              ${It("Tokens","tokens",t,e)}
              <th></th>
            </tr>
          </thead>
          <tbody>
    ...
    `}};Ot.styles=zt,t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"_users",void 0),t([ut()],Ot.prototype,"_risk",void 0),t([ut()],Ot.prototype,"_loading",void 0),t([ut()],Ot.prototype,"_busyUserId",void 0),t([ut()],Ot.prototype,"_sort",void 0),t([ut()],Ot.prototype,"_isOwner",void 0),Ot=t([dt("ha-soc-users-view")],Ot);const Nt=[["","All categories"],["service_call","Service call"],["login_ok","Login OK"],["login_fail","Login failed"],["token_created","Token created"],["session_seen","Session first seen"],["user_added","User added"],["user_updated","User updated"],["user_removed","User removed"],["lovelace_change","Dashboard edit"],["dashboard_panels_change","Panel set changed"],["entity_registry_change","Entity registry"],["device_registry_change","Device registry"],["area_registry_change","Area registry"],["floor_registry_change","Floor registry"],["label_registry_change","Label registry"],["category_registry_change","Category registry"],["config_entry_change","Config entry"],["core_config_change","Core config"],["watchdog_triggered","Watchdog triggered"],["soc_config_change","SOC config change"]];let Lt=class extends rt{constructor(){super(...arguments),this._events=[],this._users=[],this._loading=!0,this._category="",this._userId="",this._verifyResult=null,this._sort=null}connectedCallback(){super.connectedCallback(),this._loadUsers(),this._load()}async _loadUsers(){this._users=await gt(this.hass)}async _load(){this._loading=!0;try{this._events=await((t,e={})=>_t(t,{type:"ha_soc/audit/query",...e}).then(t=>t.events))(this.hass,{category:this._category||void 0,user_id:this._userId||void 0,limit:200})}finally{this._loading=!1}}_nameFor(t){return t?this._users.find(e=>e.id===t)?.name??t:"—"}async _onVerify(){var t;this._verifyResult=await(t=this.hass,_t(t,{type:"ha_soc/audit/verify_chain"}))}_onCategoryChange(t){this._category=t.target.value,this._load()}_onUserChange(t){this._userId=t.target.value,this._load()}render(){const t=this._sort,e=t=>{this._sort=t},s=Ft(this._events,t,{time:t=>Date.parse(t.ts),category:t=>t.category,user:t=>t.user_id?this._nameFor(t.user_id):null,action:t=>t.domain?`${t.domain}.${t.service}${t.entity_ids?.length?` (${t.entity_ids.join(", ")})`:""}`:null,source:t=>t.ip});return B`
      <div class="card">
        <h3>Audit Log</h3>
        <p class="muted" style="margin-top:-8px;font-size:12.5px;">
        ...
        ${this._loading?B`<div class="empty">Loading…</div>`:this._events.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Time","time",t,e)}
                    ${It("Category","category",t,e)}
                    ${It("User","user",t,e)}
                    ${It("Action","action",t,e)}
                    ${It("Source","source",t,e)}
                  </tr>
                </thead>
                <tbody>
                  ${s.map(t=>B`
    ...
    `}};Lt.styles=zt,t([pt({attribute:!1})],Lt.prototype,"hass",void 0),t([ut()],Lt.prototype,"_events",void 0),t([ut()],Lt.prototype,"_users",void 0),t([ut()],Lt.prototype,"_loading",void 0),t([ut()],Lt.prototype,"_category",void 0),t([ut()],Lt.prototype,"_userId",void 0),t([ut()],Lt.prototype,"_verifyResult",void 0),t([ut()],Lt.prototype,"_sort",void 0),Lt=t([dt("ha-soc-audit-view")],Lt);let Tt=class extends rt{constructor(){super(...arguments),this._users=[],this._dashboards=[],this._selected=void 0,this._views=[],this._loading=!0,this._drift=[],this._viewsError=null,this._sort=null}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{const[e,s]=await Promise.all([gt(this.hass),(t=this.hass,_t(t,{type:"ha_soc/permissions/dashboards/list"}).then(t=>t.dashboards))]);this._users=e.filter(t=>t.is_active),this._dashboards=s,void 0===this._selected&&s.length&&(this._selected=s[0].url_path??null),void 0!==this._selected&&await this._loadViews()}finally{this._loading=!1}var t}async _loadViews(){this._viewsError=null;try{const s=await(t=this.hass,e=this._selected??null,_t(t,{type:"ha_soc/permissions/dashboard_config",url_path:e}).then(t=>t.config)),i=s?.views??[];this._views=i.map((t,e)=>({path:t.path??String(e),title:t.title??t.path??`View ${e+1}`,visibleUserIds:Array.isArray(t.visible)?t.visible.map(t=>t.user):null}))}catch(t){this._views=[],this._viewsError="not_found"===t?.code?"This dashboard has no saved layout yet — Home Assistant is showing an auto-generated default until someone opens and customizes it in the dashboard editor. There's nothing here for the permissions matrix to manage until then.":`Could not load this dashboard's views: ${t?.message??t}`}var t,e}async _onSelectDashboard(t){const e=t.target.value;this._selected="__default__"===e?null:e,await this._loadViews()}async _onToggleUser(t,e){const s=t.visibleUserIds??this._users.map(t=>t.id),i=s.includes(e)?s.filter(t=>t!==e):[...s,e],a=i.length===this._users.length?[]:i;await((t,e,s,i)=>_t(t,{type:"ha_soc/permissions/view_visibility/set",url_path:e,view_path:s,user_ids:i}))(this.hass,this._selected??null,t.path,a),await this._loadViews()}async _onToggleFlag(t,e,s){await((t,e,s)=>_t(t,{type:"ha_soc/permissions/dashboard_flags/set",dashboard_id:e,...s}))(this.hass,t,{[e]:s}),await this._load()}async _onCheckDrift(){var t;this._drift=await(t=this.hass,_t(t,{type:"ha_soc/permissions/drift/check"}).then(t=>t.drift))}render(){if(this._loading)return B`<div class="empty">Loading dashboards…</div>`;const t=this._dashboards.find(t=>(t.url_path??null)===(this._selected??null));return B`
      <div class="card">
        ...
        ${this._views.length?(()=>{const t={view:t=>t.title};for(const e of this._users)t[`user:${e.id}`]=t=>null===t.visibleUserIds||t.visibleUserIds.includes(e.id);const e=Ft(this._views,this._sort,t),s=this._sort,i=t=>this._sort=t;return B`
              <table>
                <thead>
                  <tr>
                    ${It("View","view",s,i)}
                    ${this._users.map(t=>It(t.name??t.id,`user:${t.id}`,s,i))}
                  </tr>
                </thead>
                <tbody>
                  ${e.map(t=>B`
      ...
      <div class="card">
        ...
        ${this._misconfigFindings.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Check","check",this._misconfigSort,t=>this._misconfigSort=t)}
                    ${It("Summary","summary",this._misconfigSort,t=>this._misconfigSort=t)}
                    <th>Status</th>
                  </tr>
                </thead>
                <tbody>
      ...
      <div class="card">
        ...
        ${this._scannerFindings.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Domain","domain",this._scannerSort,t=>this._scannerSort=t)}
                    ${It("Pattern","pattern",this._scannerSort,t=>this._scannerSort=t)}
                    ${It("Location","location",this._scannerSort,t=>this._scannerSort=t)}
                    ${It("Confidence","confidence",this._scannerSort,t=>this._scannerSort=t)}
                    ${It("CWE","cwe",this._scannerSort,t=>this._scannerSort=t)}
                    <th>Status</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  ${Ft(this._scannerFindings,this._scannerSort,Dt.SCANNER_SORT).map(t=>B`
                      <tr>
                        <td>${t.domain}</td>
              ...
              ${this._exportNotice?B`<p class="muted" style="font-size:12px;margin:6px 0 0;">${this._exportNotice}</p>`:j}
            `:B`<div class="empty">No findings.</div>`}
      </div>
      ...
      <div class="card">
        ...
        ${this._vulnFindings.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("CVE","cve",this._vulnSort,t=>this._vulnSort=t)}
                    ${It("CVSS","cvss",this._vulnSort,t=>this._vulnSort=t)}
                    ${It("Confidence","confidence",this._vulnSort,t=>this._vulnSort=t)}
                    <th>Status</th>
                  </tr>
                </thead>
                <tbody>
    ...
    `}_renderPortsByBindAddress(t){const e=new Map;for(const s of t){const t=s.address??"__unresolved__",i=e.get(t);i?i.push(s):e.set(t,[s])}const s=Array.from(e.entries()).sort((t,e)=>{const s=jt("__unresolved__"===t[0]?null:t[0]),i=jt("__unresolved__"===e[0]?null:e[0]);return s.priority!==i.priority?s.priority-i.priority:t[0].localeCompare(e[0])});return B`
      <table>
        <thead>
          <tr>
            ${It("Port","port",this._portSort,t=>this._portSort=t)}
            ${It("Protocol","proto",this._portSort,t=>this._portSort=t)}
            ${It("Interface","interface",this._portSort,t=>this._portSort=t)}
          </tr>
        </thead>
        ${s.map(([t,e])=>{const s="__unresolved__"===t?null:t,i=jt(s);return B`
            <tbody>
              <tr>
              ...
              ${(this._portSort?Ft(e,this._portSort,Dt.PORT_SORT):e.slice().sort((t,e)=>t.port-e.port)).map(t=>B`
                    <tr>
                      <td>${t.port}</td>
                      <td>${t.proto}</td>
                      <td>
    ...
    `}_renderFirewallCard(){const t=this._probe,e=this._firewall;return t?.supervisor&&t?.installed?this._isOwner?e?B`
      <div class="card">
        ...
        ${e.known_rules&&e.known_rules.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Action","action",this._fwRulesSort,t=>this._fwRulesSort=t)}
                    ${It("Protocol","proto",this._fwRulesSort,t=>this._fwRulesSort=t)}
                    ${It("Port","port",this._fwRulesSort,t=>this._fwRulesSort=t)}
                    ${It("Source","source",this._fwRulesSort,t=>this._fwRulesSort=t)}
                  </tr>
                </thead>
                <tbody>
                  ${Ft(e.known_rules,this._fwRulesSort,Dt.FW_RULE_SORT).map(t=>B`
                      <tr>
                        <td>
    ...
    `}_renderFirewallBuilder(t){const e=null===t&&this._fwBackupAck&&this._fwDraftRules.length>0&&this._fwDraftRules.every(t=>this._fwRuleValid(t));return B`
      ...
      ${t?B`<p class="muted" style="font-size:12px;margin:6px 0 0;">${t}</p>`:j}
    `}};Gt.styles=zt,Gt.MISCONFIG_SORT={check:t=>t.check,summary:t=>t.summary},Gt.SCANNER_SORT={domain:t=>t.domain,pattern:t=>t.pattern,location:t=>`${t.file}:${t.line}`,confidence:t=>Vt(Bt,t.confidence),cwe:t=>t.cwe},Gt.VULN_SORT={cve:t=>t.cve_id,cvss:t=>{if(null==t.cvss)return null;const e=Number(t.cvss);return Number.isNaN(e)?null:e},confidence:t=>Vt(Wt,t.confidence)},Gt.PORT_SORT={port:t=>t.port,proto:t=>t.proto,interface:t=>t.interface},Gt.FW_RULE_SORT={action:t=>t.action,proto:t=>t.proto,port:t=>t.port,source:t=>t.source??"any"},t([pt({attribute:!1})],Gt.prototype,"hass",void 0),t([ut()],Gt.prototype,"_scannerFindings",void 0),t([ut()],Gt.prototype,"_vulnFindings",void 0),t([ut()],Gt.prototype,"_misconfigFindings",void 0),t([ut()],Gt.prototype,"_probe",void 0),t([ut()],Gt.prototype,"_loading",void 0),t([ut()],Gt.prototype,"_scanning",void 0),t([ut()],Gt.prototype,"_exportNotice",void 0),t([ut()],Gt.prototype,"_firewall",void 0),t([ut()],Gt.prototype,"_fwDraftRules",void 0),t([ut()],Gt.prototype,"_fwBackupAck",void 0),t([ut()],Gt.prototype,"_fwSubmitting",void 0),t([ut()],Gt.prototype,"_fwError",void 0),t([ut()],Gt.prototype,"_isOwner",void 0),t([ut()],Gt.prototype,"_misconfigSort",void 0),t([ut()],Gt.prototype,"_scannerSort",void 0),t([ut()],Gt.prototype,"_vulnSort",void 0),t([ut()],Gt.prototype,"_portSort",void 0),t([ut()],Gt.prototype,"_fwRulesSort",void 0),Gt=Dt=t([dt("ha-soc-scanner-view")],Gt);function qt(t,e){t.dispatchEvent(new CustomEvent("ha-soc-navigate",{detail:{tab:e},bubbles:!0,composed:!0}))}function Kt(t){window.history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0}))}function Yt(t){return`/config/devices/dashboard?historyBack=1&config_entry=${t}`}var Jt;const Zt={lock:"Locks",siren:"Sirens",valve:"Valves"},Qt=[{key:"available",label:"Available"},{key:"partial",label:"Partial"},{key:"unavailable",label:"Unavailable"},{key:"disabled",label:"Disabled"},{key:"no_entities",label:"No Entities"}],Xt=["critical","high","medium","low"],te={failing:"Failing",credential:"Credential issue",communication:"Communication issue",collection:"Collection issue",errors:"Logging errors",debug_logging:"Debug logging enabled",disabled:"Disabled"},ee={failing:{label:"Unavailable",colorVar:"var(--status-critical)"},credential:{label:"Unavailable",colorVar:"var(--status-critical)"},communication:{label:"Unavailable",colorVar:"var(--status-critical)"},collection:{label:"Unavailable",colorVar:"var(--status-critical)"},errors:{label:"Warning",colorVar:"var(--status-warning)"},debug_logging:{label:"Warning",colorVar:"var(--status-warning)"},disabled:{label:"Disabled",colorVar:"var(--cat-other)"}},se=Object.fromEntries(Object.keys(te).map((t,e)=>[t,e])),ie=[20,50,100,"all"],ae=[20,50,100,"all"];let ne=Jt=class extends rt{constructor(){super(...arguments),this._summary=null,this._deviceOverview=null,this._integrationOverview=null,this._peripherals=null,this._security=null,this._detections=[],this._risk={},this._users=[],this._loading=!0,this._deviceSearch="",this._deviceStatusFilter=null,this._deviceSort={key:"risk_score",dir:-1},this._devicePageSize=20,this._integrationSearch="",this._integrationSort=null,this._integrationPageSize=20,this._detectionSort=null}connectedCallback(){super.connectedCallback(),this._load()}updated(){this.classList.toggle("dark",!!this.hass?.themes?.darkMode)}async _load(){this._loading=!0;try{const[e,s,i,a,n,o,r,l]=await Promise.all([(t=this.hass,_t(t,{type:"ha_soc/dashboard/summary"})),xt(this.hass),kt(this.hass),Pt(this.hass),Et(this.hass),mt(this.hass),vt(this.hass),gt(this.hass)]);this._summary=e,this._deviceOverview=s,this._integrationOverview=i,this._peripherals=a,this._security=n,this._detections=o,this._risk=r,this._users=l}finally{this._loading=!1}var t}async _onAck(t){await yt(this.hass,t,"ack"),await this._load()}async _onResolve(t){await yt(this.hass,t,"resolved"),await this._load()}_nameFor(t){return t?this._users.find(e=>e.id===t)?.name??t:"unknown"}_goto(t){qt(this,t)}_donutGradient(t){const e=t.reduce((t,e)=>t+e.value,0)||1;let s=0;const i=t.map(t=>{const i=s/e*100;s+=t.value;const a=s/e*100;return`${t.color} ${i}% ${a}%`});return`conic-gradient(${i.join(", ")})`}_onStatusTileClick(t){this._deviceStatusFilter=this._deviceStatusFilter===t?null:t,this.renderRoot.querySelector("#devices-card")?.scrollIntoView({behavior:"smooth",block:"start"})}_sortedFilteredDevices(){const t=this._deviceOverview?.devices??[],e=this._deviceSearch.trim().toLowerCase(),s=t.filter(t=>(!this._deviceStatusFilter||t.status===this._deviceStatusFilter)&&(!e||(t.name.toLowerCase().includes(e)||t.vendor.toLowerCase().includes(e)||t.os.toLowerCase().includes(e))));return Ft(s,this._deviceSort,Jt.DEVICE_SORT)}_filteredIntegrations(){const t=this._integrationOverview?.integrations??[],e=this._integrationSearch.trim().toLowerCase();return Ft(e?t.filter(t=>t.title.toLowerCase().includes(e)||t.domain.toLowerCase().includes(e)):t,this._integrationSort,Jt.INTEGRATION_SORT)}_statusDotColor(t){switch(t){case"unavailable":return"var(--status-critical)";case"partial":return"var(--status-warning)";case"disabled":return"var(--cat-other)";case"no_entities":return"var(--primary-color)";default:return"var(--status-good)"}}render(){if(this._loading||!this._summary||!this._deviceOverview||!this._integrationOverview)return B`<div class="empty">Loading dashboard…</div>`;const t=this._summary,e=this._deviceOverview,s=this._integrationOverview,i=Ft(this._detections.filter(t=>"open"===t.status),this._detectionSort,{time:t=>t.last_seen,rule:t=>t.title,severity:t=>{const e=Xt.indexOf(t.severity);return-1===e?Xt.length:e},user:t=>this._nameFor(t.user_id)}),a=t=>{this._detectionSort=t},n=e.devices.reduce((t,e)=>(t.critical+=e.severity_counts.critical,t.high+=e.severity_counts.high,t.medium+=e.severity_counts.medium,t.low+=e.severity_counts.low,t),{critical:0,high:0,medium:0,low:0}),o=n.critical+n.high+n.medium+n.low,r=[{key:"critical",label:"Critical",color:"var(--status-critical)",value:n.critical},{key:"high",label:"High",color:"var(--status-serious)",value:n.high},{key:"medium",label:"Medium",color:"var(--status-warning)",value:n.medium},{key:"low",label:"Low",color:"var(--status-good)",value:n.low}],l=Math.max(0,Math.min(100,e.combined_risk_score/10*100)),d=t.entity_state_counts??{unavailable:0,unknown:0},c=d.unavailable+d.unknown,h=[{key:"unavailable",label:"Failed (unavailable)",color:"var(--status-critical)",value:d.unavailable},{key:"unknown",label:"Unknown",color:"var(--status-warning)",value:d.unknown}],p=this._sortedFilteredDevices(),u="all"===this._devicePageSize?p:p.slice(0,this._devicePageSize),_=t=>{this._deviceSort=t},g=t=>{this._integrationSort=t},v=this._filteredIntegrations(),m="all"===this._integrationPageSize?v:v.slice(0,this._integrationPageSize),y=[{key:"low",color:"var(--status-good)",value:t.risk_band_counts.low??0},{key:"moderate",color:"var(--status-warning)",value:t.risk_band_counts.moderate??0},{key:"high",color:"var(--status-serious)",value:t.risk_band_counts.high??0},{key:"critical",color:"var(--status-critical)",value:t.risk_band_counts.critical??0}],f=[{key:"enabled",color:"var(--cat-1)",value:t.mfa_counts.enabled},{key:"disabled",color:"var(--cat-2)",value:t.mfa_counts.disabled}],b=[{key:"critical",color:"var(--status-critical)",value:t.detection_severity_counts.critical??0},{key:"high",color:"var(--status-serious)",value:t.detection_severity_counts.high??0},{key:"medium",color:"var(--status-warning)",value:t.detection_severity_counts.medium??0},{key:"low",color:"var(--status-good)",value:t.detection_severity_counts.low??0}];return B`
      ...
      <div class="card">
        ...
        ${i.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Time","time",this._detectionSort,a)}
                    ${It("Rule","rule",this._detectionSort,a)}
                    ${It("Severity","severity",this._detectionSort,a)}
                    ${It("User","user",this._detectionSort,a)}
                    <th></th>
                  </tr>
                </thead>
                <tbody>
        ...
        <div class="card" id="devices-card">
          ...
          ${this._deviceStatusFilter?B`
                <div class="filter-chip" @click=${()=>this._deviceStatusFilter=null}>
                  ${Qt.find(t=>t.key===this._deviceStatusFilter)?.label} ✕
                </div>
              `:j}
          ...
          ${0===p.length?B`<div class="empty">No devices found.</div>`:B`
                <div style="overflow-x:auto;">
                  <table>
                    <thead>
                      <tr>
                        ${It("Health","status",this._deviceSort,_)}
                        ${It("Device","name",this._deviceSort,_)}
                        ${It("Vendor","vendor",this._deviceSort,_)}
                        ${It("Risk Score","risk_score",this._deviceSort,_,{numeric:!0})}
                        ${It("Total","total_findings",this._deviceSort,_,{numeric:!0})}
                        ${It("Severity","severity",this._deviceSort,_)}
                      </tr>
                    </thead>
                    <tbody>
                      ${u.map(t=>B`
                          <tr
                            ...
                            @click=${()=>Kt(`/config/devices/device/${t.device_id}`)}
                          >
                ...
                ${0===v.length?B`<div class="empty">No integration matches "${this._integrationSearch}".</div>`:B`
                      <div style="overflow-x:auto;">
                        <table>
                          <thead>
                            <tr>
                              ${It("Integration","title",this._integrationSort,g)}
                              ${It("Severity","severity",this._integrationSort,g)}
                            </tr>
                          </thead>
                          <tbody>
                            ${m.map(t=>{const e=ee[t.issue_category];return B`
                                <tr
                                  class="clickable"
                                  title="${t.title} — ${te[t.issue_category]}. Open in Home Assistant's Devices page"
                                  @click=${()=>Kt(Yt(t.entry_id))}
                                >
                                  <td>${t.title}</td>
                                  <td>
                                    <span class="sev-cell">
                      ...
                      <div class="devices-footer">
                        <span
                          >Showing ${m.length} of ${v.length} integration${1===v.length?"":"s"}</span
                        >
                        <select
    ...
    `}_renderSecurityCard(){const t=this._security;if(!t)return j;const e={};for(const s of t.entities)(e[s.domain]??=[]).push(s);return B`
      <div class="card">
        <h3>
        ...
        <div class="security-health-grid">
          ${Object.entries(Zt).filter(([e])=>t.sources_enabled[e]??!0).map(([t,s])=>{const i=e[t]??[],a=i.filter(t=>t.problem).length,n=i.filter(t=>t.low_battery).length;return B`
                <div
                  class="security-source-tile ${i.length?"clickable":""}"
                  title=${i.length?`View ${s.toLowerCase()} in Home Assistant's Devices page`:""}
                  @click=${()=>i.length&&Kt(function(t){return`/config/devices/dashboard?historyBack=1&domain=${t}`}(t))}
                >
    ...
    `:B`
      ...
      `:B`
        <div class="card">
          ...
          <button class="ha-btn" @click=${()=>qt(this,"settings")}>
            Open Settings
          </button>
        </div>
        ${this._renderProtectCard(t)}
    ...
    `}_colHeaders(){const t=this._clientSort,e=t=>{this._clientSort=t,this._clientPage=0};return B`
      <tr>
        ...
        ${It("IPv6","ipv6",t,e)}
        ${It("MAC","mac",t,e)}
        ${It("VLAN","vlan",t,e,{numeric:!0})}
        ${It("SSID","ssid",t,e)}
        ${It("Uptime","uptime",t,e,{numeric:!0})}
        ${It("Bandwidth","bandwidth",t,e)}
        ${It("Last Seen","last_seen",t,e)}
        ${It("Integration","integration",t,e)}
      </tr>
    ...
    `}_renderClientsTable(t){const e=Array.from(new Set(t.clients.map(t=>null==t.vlan||""===t.vlan?null:String(t.vlan)).filter(Boolean))).sort((t,e)=>Number(t)-Number(e)),s=Array.from(new Set(t.clients.map(t=>t.ssid).filter(Boolean))).sort();let i=this._filter(t.clients,this._clientSearch);this._clientVlanFilter&&(i=i.filter(t=>String(t.vlan??"")===this._clientVlanFilter)),this._clientSsidFilter&&(i=i.filter(t=>t.ssid===this._clientSsidFilter)),i=Ft(i,this._clientSort,oe.CLIENT_SORT);const a=this._paginate(i,this._clientPage,this._clientPageSize);return B`
    ...
    `}_renderDevicesTable(t){const e=Ft(this._filter(t.devices,this._deviceSearch),this._deviceSort,oe.DEVICE_SORT),s=this._paginate(e,this._devicePage,this._devicePageSize),i=this._deviceSort,a=t=>{this._deviceSort=t,this._devicePage=0};return B`
      <div class="card">
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      ${It("IPv4","ipv4",i,a)}
                      ${It("MAC","mac",i,a)}
                      ${It("VLAN","vlan",i,a,{numeric:!0})}
                      ${It("Model","model",i,a)}
                      ${It("Firmware","firmware",i,a)}
                      ${It("Bandwidth","bandwidth",i,a)}
                      ${It("Last Seen","last_seen",i,a)}
                      ${It("Integration","integration",i,a)}
                    </tr>
                  </thead>
                  <tbody>
        ...
        ${t.available?t.rules.length?B`
                <div class="table-wrap">
                  <table>
                    <thead>
                      <tr>
                        ${It("#","order",this._aclSort,t=>this._aclSort=t,{numeric:!0})}
                        ${It("Name","name",this._aclSort,t=>this._aclSort=t)}
                        ${It("Action","action",this._aclSort,t=>this._aclSort=t)}
                        ${It("Networks","networks",this._aclSort,t=>this._aclSort=t)}
                        ${It("Direction","direction",this._aclSort,t=>this._aclSort=t)}
                        ${It("Protocol","protocol",this._aclSort,t=>this._aclSort=t)}
                        ${It("Enabled","enabled",this._aclSort,t=>this._aclSort=t)}
                      </tr>
                    </thead>
                    <tbody>
                      ${Ft(t.rules.slice(),this._aclSort,{order:t=>t.order,name:t=>t.name,action:t=>t.action,networks:t=>t.networks.join(", ")||null,direction:t=>t.direction,protocol:t=>t.protocol,enabled:t=>t.enabled}).map((t,e)=>B`
                          <tr>
    ...
    `}_renderPager(t,e,s,i,a){const n="all"===s?1:Math.max(1,Math.ceil(t/s));return B`
      <div class="footer">
        ...
        >
          ${re.map(t=>B`<option value=${String(t)} ?selected=${t===s}>${"all"===t?"All":`${t} / page`}</option>`)}
        </select>
      </div>
    ...
    `:B`
      ...
      `:j}_renderProtectDevices(t){if(!t.length)return B`<div class="empty">No Protect devices reported.</div>`;const e=this._protectSort,s=t=>this._protectSort=t,i=Ft(t.slice(),e,{name:t=>t.name,ip:t=>t.ip,mac:t=>t.mac,recording:t=>t.is_recording,last_ring:t=>t.last_ring,channels:t=>t.channel_count});return B`
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              ...
              ${It("IP","ip",e,s)}
              ${It("MAC","mac",e,s)}
              ${It("Recording","recording",e,s)}
              ${It("Last Ring","last_ring",e,s)}
              ${It("Channels","channels",e,s)}
              <th></th>
            </tr>
          </thead>
          <tbody>
        ...
        ${t.events_error?B`<div class="note" style="font-size:13px;">${t.events_error}</div>`:t.events.length?B`
                <div class="table-wrap">
                  <table>
                    <thead>
                      <tr>
                        ${It("Type","type",this._eventSort,t=>this._eventSort=t)}
                        ${It("Smart Detections","detections",this._eventSort,t=>this._eventSort=t)}
                        ${It("Score","score",this._eventSort,t=>this._eventSort=t,{numeric:!0})}
                        ${It("Start","start",this._eventSort,t=>this._eventSort=t)}
                        ${It("Duration","duration",this._eventSort,t=>this._eventSort=t,{numeric:!0})}
                        <th>Thumbnail</th>
                        ${It("License Plate","plate",this._eventSort,t=>this._eventSort=t)}
                      </tr>
                    </thead>
                    <tbody>
                      ${Ft(t.events.slice(),this._eventSort,{type:t=>t.type,detections:t=>t.smart_detect_types.join(", ")||null,score:t=>t.score,start:t=>t.start,duration:t=>t.duration,plate:t=>t.license_plate}).map(t=>B`
                          <tr>
                            <td>${t.type??"—"}</td>
                            <td>
    ...
    `}};var de;function ce(t){const e=t.match(/^homeassistant\.components\.([^.]+)/);if(e)return e[1];const s=t.match(/^custom_components\.([^.]+)/);return s?s[1]:t.split(".")[0]}le.styles=[zt,o`
      .stat-row {
        display: grid;
        grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));
        gap: 12px;
    ...
    `],le.CLIENT_SORT={name:t=>t.name,ipv4:t=>t.ipv4,ipv6:t=>t.ipv6,mac:t=>t.mac,vlan:t=>null==t.vlan||""===t.vlan?null:Number(t.vlan),ssid:t=>t.ssid??(t.wired?"wired":null),uptime:t=>t.uptime,bandwidth:t=>t.bandwidth?.total_bytes??null,last_seen:t=>t.last_seen,integration:t=>t.integration_match?.domain??null},le.DEVICE_SORT={name:t=>t.name,ipv4:t=>t.ipv4,mac:t=>t.mac,vlan:t=>null==t.vlan||""===t.vlan?null:Number(t.vlan),model:t=>t.model,firmware:t=>t.firmware_updatable,bandwidth:t=>t.bandwidth?.total_bytes??null,last_seen:t=>t.last_seen,integration:t=>t.integration_match?.domain??null},t([pt({attribute:!1})],le.prototype,"hass",void 0),t([ut()],le.prototype,"_overview",void 0),t([ut()],le.prototype,"_loading",void 0),t([ut()],le.prototype,"_error",void 0),t([ut()],le.prototype,"_clientSearch",void 0),t([ut()],le.prototype,"_clientPage",void 0),t([ut()],le.prototype,"_clientPageSize",void 0),t([ut()],le.prototype,"_clientVlanFilter",void 0),t([ut()],le.prototype,"_clientSsidFilter",void 0),t([ut()],le.prototype,"_clientSort",void 0),t([ut()],le.prototype,"_deviceSearch",void 0),t([ut()],le.prototype,"_devicePage",void 0),t([ut()],le.prototype,"_devicePageSize",void 0),t([ut()],le.prototype,"_deviceSort",void 0),t([ut()],le.prototype,"_aclSort",void 0),t([ut()],le.prototype,"_protectSort",void 0),t([ut()],le.prototype,"_eventSort",void 0),le=oe=t([dt("ha-soc-network-view")],le);const he=["DEBUG","INFO","WARNING","ERROR","CRITICAL"];const pe="system";let ue=de=class extends rt{constructor(){super(...arguments),this._entries=[],this._fault=null,this._loading=!0,this._domainFilter="",this._levelFilter="",this._expanded=new Set,this._sort=null,this._targets=null,this._source=pe,this._containerLog=null,this._containerLoading=!1}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{const[e,s,i]=await Promise.all([(t=this.hass,_t(t,{type:"system_log/list"})),bt(this.hass),$t(this.hass).catch(()=>null)]);this._entries=e,this._fault=s,this._targets=i}finally{this._loading=!1}var t}async _loadContainer(t){this._containerLoading=!0;try{this._containerLog=await((t,e)=>_t(t,{type:"ha_soc/logs/container",target:e}))(this.hass,t)}catch(e){this._containerLog={available:!1,target:t,content:null,truncated:!1,error:String(e),fetched_at:(new Date).toISOString()}}finally{this._containerLoading=!1}}_onSourceChange(t){const e=t.target.value;this._source=e,this._containerLog=null,e!==pe&&this._loadContainer(e)}_refresh(){this._source===pe?this._load():this._loadContainer(this._source)}_toggleExpanded(t){const e=new Set(this._expanded);e.has(t)?e.delete(t):e.add(t),this._expanded=e}get _domains(){return Array.from(new Set(this._entries.map(t=>ce(t.name)))).sort()}get _levels(){const t=new Set(this._entries.map(t=>t.level.toUpperCase()));return he.filter(e=>t.has(e))}get _filtered(){const t=this._entries.filter(t=>(!this._domainFilter||ce(t.name)===this._domainFilter)&&(!this._levelFilter||t.level.toUpperCase()===this._levelFilter));return Ft(t,this._sort,de.LOG_SORT)}_renderFaultLogCard(){const t=this._fault;return t?B`
    ...
    `:j}_renderContainerLog(){const t=this._containerLog,e=this._targets?.targets.find(t=>t.id===this._source)?.name??this._source;return this._containerLoading&&!t?B`<div class="empty">Loading ${e} logs…</div>`:t?t.available?B`
      <p class="muted" style="font-size:12px;">
    ...
    `:B`<div class="empty">
        Couldn't load ${e} logs${t.error?B`<br /><span class="muted">${t.error}</span>`:j}
      </div>`:B`<div class="empty">Select a source.</div>`}render(){const t=this._filtered,e=this._sort,s=t=>{this._sort=t,this._expanded=new Set},i=this._source===pe;return B`
              ...
              <table>
                <thead>
                  <tr>
                    ${It("Time","time",e,s)}
                    ${It("Level","level",e,s)}
                    ${It("Integration","integration",e,s)}
                    ${It("Message","message",e,s)}
                    ${It("Count","count",e,s,{numeric:!0})}
                  </tr>
                </thead>
                <tbody>
                  ${t.map((t,e)=>{const s=this._expanded.has(e);return B`
                      ...
                      >
                        ...
                        <td>
                          <span class="log-level ${function(t){const e=t.toUpperCase();return he.includes(e)?e.toLowerCase():"info"}(t.level)}"
                            ><span class="dot"></span>${t.level}</span
                          >
                        </td>
                        <td class="muted">${ce(t.name)}</td>
                        <td>
...
${t.exception}</pre
    ...
    `],ue.LOG_SORT={time:t=>t.first_occurred,level:t=>{const e=he.indexOf(t.level.toUpperCase());return-1===e?null:e},integration:t=>ce(t.name),message:t=>t.message[t.message.length-1],count:t=>t.count},t([pt({attribute:!1})],ue.prototype,"hass",void 0),t([ut()],ue.prototype,"_entries",void 0),t([ut()],ue.prototype,"_fault",void 0),t([ut()],ue.prototype,"_loading",void 0),t([ut()],ue.prototype,"_domainFilter",void 0),t([ut()],ue.prototype,"_levelFilter",void 0),t([ut()],ue.prototype,"_expanded",void 0),t([ut()],ue.prototype,"_sort",void 0),t([ut()],ue.prototype,"_targets",void 0),t([ut()],ue.prototype,"_source",void 0),t([ut()],ue.prototype,"_containerLog",void 0),t([ut()],ue.prototype,"_containerLoading",void 0),ue=de=t([dt("ha-soc-logs-view")],ue);let ge=_e=class extends rt{constructor(){super(...arguments),this._overview=null,this._loading=!0,this._busyKey=null,this._showIgnored=!1,this._sort=null,this._ignoredSort=null}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{this._overview=await Pt(this.hass)}finally{this._loading=!1}}async _onToggleIgnore(t,e,s){this._busyKey=t;try{await((t,e,s,i)=>_t(t,{type:"ha_soc/peripherals/set_ignored",key:e,ignored:s,raw_name:i}))(this.hass,t,e,s),await this._load()}finally{this._busyKey=null}}render(){if(this._loading)return B`<div class="empty">Loading peripherals…</div>`;const t=this._overview;if(!t||!t.available)return B`
        <div class="card">
      ...
      <div class="card">
        ...
        ${t.devices.length?B`
              <table>
                <thead>
                  <tr>
                    ${It("Raw Name","name",this._sort,t=>this._sort=t)}
                    ${It("/dev/tty Path","tty",this._sort,t=>this._sort=t)}
                    ${It("By-ID Path","by_id",this._sort,t=>this._sort=t)}
                    ${It("VID:PID","vidpid",this._sort,t=>this._sort=t)}
                    ${It("Serial","serial",this._sort,t=>this._sort=t)}
                    ${It("Assigned Integration","integration",this._sort,t=>this._sort=t)}
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  ${Ft(e,this._sort,_e.DEVICE_SORT).map(t=>B`
                      <tr>
                        <td>${t.raw_name}</td>
            ...
            <div class="card">
              ...
              ${this._showIgnored?B`
                    <table>
                      <thead>
                        <tr>
                          ${It("Raw Name","name",this._ignoredSort,t=>this._ignoredSort=t)}
                          ${It("/dev/tty Path","tty",this._ignoredSort,t=>this._ignoredSort=t)}
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
                        ${Ft(s,this._ignoredSort,_e.DEVICE_SORT).map(t=>B`
    ...
    `:j}render(){const t=this._report,e=!!t&&t.editable_count>0&&!!this._newEntityId&&this._newEntityId!==this._oldEntityId&&this._backupAck;return B`
      <div class="card" id="remap-card">
        ...
        ${this._applyResult?B`
              <div class="card" style="margin-top:12px;background:rgba(67,160,71,0.08);">
                <strong>Applied.</strong> ${Object.entries(this._applyResult.fixed).filter(([,t])=>t>0).map(([t,e])=>`${e} ${me[t]??t}`).join(", ")||"Nothing needed changing."}
      ...
      <div class="card">
        ...
        ${this._brokenLoading?B`<div class="empty">Loading…</div>`:this._broken.length?this._filteredBroken().length?B`
                <table>
                  <thead>
                    <tr>
                      ${It("Entity ID","entity_id",this._brokenSort,t=>this._brokenSort=t)}
                      ${It("Referenced by","referenced_by",this._brokenSort,t=>this._brokenSort=t)}
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    ${Ft(this._filteredBroken(),this._brokenSort,ve.BROKEN_SORT).map(t=>B`
                        <tr>
                          <td>
                            <code
    ...
    `}};var fe;ye.styles=zt,ye.BROKEN_SORT={entity_id:t=>t.entity_id,referenced_by:t=>t.referenced_by[0]?.name??null},t([pt({attribute:!1})],ye.prototype,"hass",void 0),t([ut()],ye.prototype,"_entities",void 0),t([ut()],ye.prototype,"_oldEntityId",void 0),t([ut()],ye.prototype,"_newEntityId",void 0),t([ut()],ye.prototype,"_report",void 0),t([ut()],ye.prototype,"_finding",void 0),t([ut()],ye.prototype,"_applying",void 0),t([ut()],ye.prototype,"_applyResult",void 0),t([ut()],ye.prototype,"_backupAck",void 0),t([ut()],ye.prototype,"_applyError",void 0),t([ut()],ye.prototype,"_broken",void 0),t([ut()],ye.prototype,"_brokenLoading",void 0),t([ut()],ye.prototype,"_brokenFilter",void 0),t([ut()],ye.prototype,"_brokenSort",void 0),t([ut()],ye.prototype,"_isOwner",void 0),t([ut()],ye.prototype,"_filterSameType",void 0),ye=ve=t([dt("ha-soc-entity-remap-view")],ye);const be={core:"Core",hacs:"HACS",custom:"Custom"},$e={core:"good",hacs:"medium",custom:"high"},we={core:0,hacs:1,custom:2},xe={custom_repo:"Custom repo",custom_source_list:"Custom source-list"};let ke=fe=class extends rt{constructor(){super(...arguments),this._overview=null,this._loading=!0,this._refreshing=!1,this._search="",this._tierFilter="all",this._limit=25,this._intSort=null,this._containerSort=null,this._containers=null,this._containersLoading=!0,this._watchdog=null,this._editSlug=null,this._wdError=null}connectedCallback(){super.connectedCallback(),this._load(),this._loadContainers(),this._loadWatchdog()}async _loadWatchdog(){try{this._watchdog=await(t=this.hass,_t(t,{type:"ha_soc/watchdog/status"}))}catch{this._watchdog=null}var t}async _setWatchdog(t){this._wdError=null;try{this._watchdog=await((t,e)=>_t(t,{type:"ha_soc/watchdog/set",...e}))(this.hass,t)}catch(t){this._wdError=t&&"object"==typeof t&&"code"in t&&"unauthorized"===t.code?"Watchdog and cap configuration are available to the account owner only.":`Could not save: ${t instanceof Error?t.message:JSON.stringify(t)}`}}async _load(){this._loading=!0;try{this._overview=await(t=this.hass,_t(t,{type:"ha_soc/integration_security/list"}))}finally{this._loading=!1}var t}async _loadContainers(){this._containersLoading=!0;try{this._containers=await(t=this.hass,_t(t,{type:"ha_soc/containers/resources"}))}catch{this._containers=null}finally{this._containersLoading=!1}var t}async _onRefresh(){this._refreshing=!0;try{await(t=this.hass,_t(t,{type:"ha_soc/integration_security/refresh"})),await this._load()}finally{this._refreshing=!1}var t}_filtered(){const t=this._overview?.integrations??[],e=this._search.trim().toLowerCase(),s=t.filter(t=>"all"===this._tierFilter||t.tier===this._tierFilter).filter(t=>!e||t.name.toLowerCase().includes(e)||t.domain.toLowerCase().includes(e));return this._intSort?Ft(s,this._intSort,fe.INTEGRATION_SORT):s.sort((t,e)=>t.name.localeCompare(e.name))}render(){if(this._loading||!this._overview)return B`<div class="empty">Loading integrations…</div>`;const t=this._overview,e=this._filtered(),s=e.slice(0,this._limit),i=this._intSort,a=t=>{this._intSort=t,this._limit=25};return B`
      <div class="card">
        ...
        ${e.length?B`
              <div style="overflow-x:auto;">
                <table>
                  <thead>
                    <tr>
                      ${It("Integration","name",i,a)}
                      ${It("Source","tier",i,a)}
                      ${It("Quality","quality",i,a)}
                      ${It("License","license",i,a)}
                      ${It("Scanner","scanner",i,a)}
                      ${It("Signed","signed",i,a)}
                      ${It("Release","release",i,a)}
                      ${It("Stars","stars",i,a)}
                      ${It("Last push","pushed",i,a)}
                    </tr>
                  </thead>
                  <tbody>
        ...
        ${this._containersLoading&&!t?B`<div class="empty">Loading container stats…</div>`:t&&t.available?t.containers.length?B`
                  <div style="overflow-x:auto;">
                    <table>
                      <thead>
                        <tr>
                          ${It("Container","name",e,s)}
                          ${It("State","state",e,s)}
                          ${It("CPU","cpu",e,s,{numeric:!0})}
                          ${It("Memory","memory",e,s,{numeric:!0})}
                          ${It("Used / Limit","usage",e,s)}
                          ${It("Net ↓/↑","net",e,s)}
                          ${It("Disk R/W","disk",e,s)}
                          ${It("Flags","flags",e,s)}
                          <th>Watchdog / Cap</th>
                        </tr>
                      </thead>
                      <tbody>
                        ${Ft(t.containers,e,fe.CONTAINER_SORT).map(t=>this._renderContainerRow(t))}
                      </tbody>
                    </table>
                  </div>
                  ${this._renderEditor()}
      ...
      <tr>
        <td>
          ...
          ${t.flags.length?B`<div class="chips" style="margin-top:3px;">
                ${t.flags.map(t=>B`<span class="pill high"><span class="dot"></span>${xe[t]??t}</span>`)}
              </div>`:j}
        </td>
        <td>
          <span class="pill ${$e[t.tier]}"><span class="dot"></span>${be[t.tier]}</span>
        </td>
    ...
    `}};ke.styles=zt,ke.INTEGRATION_SORT={name:t=>t.name,tier:t=>we[t.tier],quality:t=>t.quality_scale,license:t=>t.license_present,scanner:t=>t.scanner_findings,signed:t=>t.github?.commit_verified??null,release:t=>{const e=t.github;return e?e.archived?2:null===e.has_release?null:e.has_release?0:1:null},stars:t=>t.github?.stars??null,pushed:t=>t.github?.pushed_at??null},ke.CONTAINER_SORT={name:t=>t.name,state:t=>"started"===t.state||"addon"!==t.kind?"running":t.state??"stopped",cpu:t=>t.cpu_percent,memory:t=>t.memory_percent,usage:t=>t.memory_usage,net:t=>null==t.network_rx&&null==t.network_tx?null:(t.network_rx??0)+(t.network_tx??0),disk:t=>null==t.blk_read&&null==t.blk_write?null:(t.blk_read??0)+(t.blk_write??0),flags:t=>t.flags.length},t([pt({attribute:!1})],ke.prototype,"hass",void 0),t([ut()],ke.prototype,"_overview",void 0),t([ut()],ke.prototype,"_loading",void 0),t([ut()],ke.prototype,"_refreshing",void 0),t([ut()],ke.prototype,"_search",void 0),t([ut()],ke.prototype,"_tierFilter",void 0),t([ut()],ke.prototype,"_limit",void 0),t([ut()],ke.prototype,"_intSort",void 0),t([ut()],ke.prototype,"_containerSort",void 0),t([ut()],ke.prototype,"_containers",void 0),t([ut()],ke.prototype,"_containersLoading",void 0),t([ut()],ke.prototype,"_watchdog",void 0),t([ut()],ke.prototype,"_editSlug",void 0),t([ut()],ke.prototype,"_wdError",void 0),ke=fe=t([dt("ha-soc-integration-security-view")],ke);const Se=1048576,Ae=[{domain:"lock",label:"Lock entities (any integration)"},{domain:"siren",label:"Siren entities (any integration)"},{domain:"valve",label:"Valve entities (any integration)"}],Ce=[{domain:"kidde_homesafe",label:"Kidde HomeSafe"},{domain:"elkm1",label:"Elk-M1 Security"},{domain:"unifiprotect",label:"UniFi Protect"},{domain:"keymaster",label:"Keymaster"},{domain:"emporia_vue",label:"Emporia Vue"}];let Pe=class extends rt{constructor(){super(...arguments),this._settings=null,this._security=null,this._loading=!0}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{this._settings=await(t=this.hass,_t(t,{type:"ha_soc/settings/get"}));try{this._security=await Et(this.hass)}catch{this._security=null}}finally{this._loading=!1}var t}async _update(t,e){if(!this._settings)return;const s=this._settings;this._settings={...this._settings,[t]:e};try{this._settings=await(i=this.hass,a={[t]:e},_t(i,{type:"ha_soc/settings/set",...a}))}catch(t){throw this._settings=s,t}var i,a}_updateSecuritySource(t,e){this._settings&&this._update("security_sources_enabled",{...this._settings.security_sources_enabled,[t]:e})}_renderSecretField(t,e,s){return B`
      ...
      <div class="card">
        ...
        <label class="settings-row">
          ...
          <input
            type="number"
            min="1"
            .value=${String(Math.round(t.audit_max_bytes/Se))}
            @change=${t=>this._update("audit_max_bytes",Math.round(Number(t.target.value)*Se))}
          />
        </label>
      </div>
    ...
    `}};Pe.styles=zt,t([pt({attribute:!1})],Pe.prototype,"hass",void 0),t([ut()],Pe.prototype,"_settings",void 0),t([ut()],Pe.prototype,"_security",void 0),t([ut()],Pe.prototype,"_loading",void 0),Pe=t([dt("ha-soc-settings-view")],Pe);const Re=[{id:"dashboard",label:"Dashboard"},{id:"network",label:"Network"},{id:"entity_remap",label:"Entity ReMap"},{id:"integration_security",label:"Integration Security"},{id:"users",label:"Users & Access"},{id:"permissions",label:"Permissions"},{id:"audit",label:"Audit Log"},{id:"peripherals",label:"Local Peripherals"},{id:"scanner",label:"Scanner"},{id:"logs",label:"Logs"},{id:"settings",label:"Settings",ownerOnly:!0}];let Ee=class extends rt{constructor(){super(...arguments),this._tab="dashboard",this._access=null,this._version=null,this._probe=null}connectedCallback(){super.connectedCallback(),this._loadAccess(),this._loadFooterInfo()}async _loadAccess(){try{this._access=await St(this.hass)}catch{this._access={is_owner:!1,access_level:"owner_only",allowed:!1}}}async _loadFooterInfo(){try{this._version=(await(t=this.hass,_t(t,{type:"ha_soc/version/get"}))).version}catch{this._version=null}var t;try{this._probe=await At(this.hass)}catch{this._probe=null}}_renderFooter(){if(!this._version)return B``;const t=this._probe?.installed&&this._probe.version?` · HA SOC Probe v${this._probe.version}`:"";return B`<div class="footer">HA SOC v${this._version}${t}</div>`}render(){return null===this._access?B`<div class="header">🛡️ HA SOC</div>`:this._access.allowed?B`
      <div class="header">🛡️ HA SOC</div>
      <div class="tabs">
        ${Re.map(t=>!!t.ownerOnly&&!this._access?.is_owner?B`
    ...
    `:B`
      ...
      `}_onNavigate(t){this._tab=t.detail.tab}_renderTab(){switch(this._tab){case"users":return B`<ha-soc-users-view .hass=${this.hass}></ha-soc-users-view>`;case"audit":return B`<ha-soc-audit-view .hass=${this.hass}></ha-soc-audit-view>`;case"permissions":return B`<ha-soc-permissions-view .hass=${this.hass}></ha-soc-permissions-view>`;case"scanner":return B`<ha-soc-scanner-view .hass=${this.hass}></ha-soc-scanner-view>`;case"logs":return B`<ha-soc-logs-view .hass=${this.hass}></ha-soc-logs-view>`;case"peripherals":return B`<ha-soc-peripherals-view .hass=${this.hass}></ha-soc-peripherals-view>`;case"network":return B`<ha-soc-network-view .hass=${this.hass}></ha-soc-network-view>`;case"entity_remap":return B`<ha-soc-entity-remap-view .hass=${this.hass}></ha-soc-entity-remap-view>`;case"integration_security":return B`<ha-soc-integration-security-view .hass=${this.hass}></ha-soc-integration-security-view>`;case"settings":return this._access?.is_owner?B`<ha-soc-settings-view .hass=${this.hass}></ha-soc-settings-view>`:B`<div class="denied"><div class="icon">🔒</div><h2>Owner only</h2>
            <p>The Settings tab is available to the account owner only.</p></div>`;default:return B`<ha-soc-dashboard-view .hass=${this.hass}></ha-soc-dashboard-view>`}}};Ee.styles=o`
    :host {
      display: block;
  ...
  `,t([pt({attribute:!1})],Ee.prototype,"hass",void 0),t([pt({attribute:!1})],Ee.prototype,"narrow",void 0),t([pt({attribute:!1})],Ee.prototype,"panel",void 0),t([ut()],Ee.prototype,"_tab",void 0),t([ut()],Ee.prototype,"_access",void 0),t([ut()],Ee.prototype,"_version",void 0),t([ut()],Ee.prototype,"_probe",void 0),Ee=t([dt("ha-soc-panel")],Ee);export{Ee as HaSocPanel};

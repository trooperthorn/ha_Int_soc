 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}const _t=(t,e)=>t.callWS(e),gt=t=>_t(t,{type:"ha_soc/users/list"}).then(t=>t.users),vt=t=>_t(t,{type:"ha_soc/risk/list"}).then(t=>t.risk),mt=(t,e)=>_t(t,{type:"ha_soc/detections/list",status:e}).then(t=>t.detections),yt=(t,e,s)=>_t(t,{type:"ha_soc/detections/set_status",detection_id:e,status:s}),ft=t=>_t(t,{type:"ha_soc/vulns/list"}).then(t=>t.findings),bt=t=>_t(t,{type:"ha_soc/logs/fault"}),$t=t=>_t(t,{type:"ha_soc/logs/targets"}),wt=t=>_t(t,{type:"ha_soc/health/list"}),xt=t=>_t(t,{type:"ha_soc/dashboard/devices"}),kt=t=>_t(t,{type:"ha_soc/dashboard/integrations"}),St=t=>_t(t,{type:"ha_soc/probe/status"}),At=t=>_t(t,{type:"ha_soc/firewall/status"}),Ct=t=>_t(t,{type:"ha_soc/peripherals/list"}),Pt=t=>_t(t,{type:"ha_soc/entity_remap/broken_references"}).then(t=>t.broken),Rt=t=>_t(t,{type:"ha_soc/security_health/list"}),Et=o`
  :host {
    display: block;
    padding: 16px;
    max-width: 1400px;
...
${t.exception}</pre
    ...
    `}_renderRow(t){const e=t.github;return B`
      <tr>
        ...
        <td>
          <span class="pill ${be[t.tier]}"><span class="dot"></span>${fe[t.tier]}</span>
        </td>

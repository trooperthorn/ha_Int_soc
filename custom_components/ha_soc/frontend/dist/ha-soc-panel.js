...
`;let kt=class extends nt{constructor(){super(...arguments),this._users=[],this._risk={},this._loading=!0,this._busyUserId=null}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0;try{const[t,e]=await Promise.all([gt(this.hass),_t(this.hass)]);this._users=t,this._risk=e}finally{this._loading=!1}}_fmtDate(t){if(!t)return"never";return new Date(t).toLocaleString()}async _onDeactivate(t){if(confirm("Deactivate this user? All their sessions will be revoked.")){this._busyUserId=t;try{await((t,e)=>vt(t,{type:"ha_soc/users/deactivate",user_id:e}))(this.hass,t),await this._load()}finally{this._busyUserId=null}}}async _onRevokeAll(t){if(confirm("Revoke every interactive session for this user? Long-lived tokens are kept.")){this._busyUserId=t;try{await((t,e)=>vt(t,{type:"ha_soc/users/revoke_all_sessions",user_id:e}))(this.hass,t),await this._load()}finally{this._busyUserId=null}}}async _onResetPassword(t){const e=prompt("New password for this user (owner-only action):");if(e){this._busyUserId=t;try{const s=await((t,e,s)=>vt(t,{type:"ha_soc/users/set_password",user_id:e,password:s}))(this.hass,t,e);s&&!1===s.ok&&alert("Could not set password — only the account owner can reset another user's password.")}finally{this._busyUserId=null}}}render(){return this._loading?j`<div class="empty">Loading users…</div>`:this._users.length?j`
                    ...
                    <tbody>
                      ${this._sortedFilteredDevices().map(t=>j`
                          <tr
                            ...
                            @click=${()=>Pt(`/config/devices/device/${t.device_id}`)}
                          >
                ...
                <div class="vbar-chart">
                  ${d.map(t=>{const e=Math.max(6,t.error_count_24h/l*100),s=this._issueCategoryColor(t.issue_category);return j`
                      <div
                        ...
                        title="${t.title} — ${zt[t.issue_category]}. Open in Home Assistant's Devices page"
                        @click=${()=>Pt(`/config/devices/dashboard?historyBack=1&config_entry=${t.entry_id}`)}
                      >
    ...
    `}_sortArrow(t){return this._deviceSort.key!==t?B:j`<span class="arrow">${"asc"===this._deviceSort.dir?"▲":"▼"}</span>`}};Dt.styles=[xt,r`
      h2.section-title {
        font-size: 13px;
        text-transform: uppercase;
      ...
      <div class="card">
        ...
        <label class="settings-row">
          ...
          <input
            type="number"
            min="1"
            .value=${String(Math.round(t.audit_max_bytes/Mt))}
            @change=${t=>this._set("audit_max_bytes",Math.round(Number(t.target.value)*Mt))}
          />
        </label>
      </div>
    ...
    `}};Nt.styles=xt,t([pt({attribute:!1})],Nt.prototype,"hass",void 0),t([ut()],Nt.prototype,"_saved",void 0),t([ut()],Nt.prototype,"_draft",void 0),t([ut()],Nt.prototype,"_loading",void 0),t([ut()],Nt.prototype,"_saving",void 0),t([ut()],Nt.prototype,"_justSaved",void 0),Nt=t([dt("ha-soc-settings-view")],Nt);const Tt=[{id:"dashboard",label:"Dashboard"},{id:"users",label:"Users & Access"},{id:"audit",label:"Audit Log"},{id:"permissions",label:"Permissions"},{id:"scanner",label:"Scanner"},{id:"settings",label:"Settings"}];let Ht=class extends nt{constructor(){super(...arguments),this._tab="dashboard",this._access=null}connectedCallback(){super.connectedCallback(),this._loadAccess()}async _loadAccess(){try{this._access=await(t=this.hass,vt(t,{type:"ha_soc/access/info"}))}catch{this._access={is_owner:!1,access_level:"owner_only",allowed:!1}}var t}render(){return null===this._access?j`<div class="header">🛡️ HA SOC</div>`:this._access.allowed?j`
  ...
  `,t([pt({attribute:!1})],Ht.prototype,"hass",void 0),t([pt({attribute:!1})],Ht.prototype,"narrow",void 0),t([pt({attribute:!1})],Ht.prototype,"panel",void 0),t([ut()],Ht.prototype,"_tab",void 0),t([ut()],Ht.prototype,"_access",void 0),Ht=t([dt("ha-soc-panel")],Ht);export{Ht as HaSocPanel};

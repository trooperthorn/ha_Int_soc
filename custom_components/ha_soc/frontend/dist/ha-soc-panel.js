    ...
    `:V`<p class="muted" style="margin:6px 0;font-size:12px;">
      ...
      ${t.results.map(t=>V`
          <div style="margin-bottom:10px;">
            ...
            ${t.analysis?this._renderApLogAnalysis(t.analysis):W}

                ...
                <div class="issues-list">
                  ${s.integrations.map(t=>j`
                      <div
                        ...
                        @click=${()=>Ft(`/config/devices/dashboard?historyBack=1&config_entry=${t.entry_id}`)}
                      >
      ...
      <div class="card">
        ...
        <div class="security-health-grid">
          ${Object.entries(Ht).filter(([e])=>t.sources_enabled[e]??!0).map(([t,s])=>{const i=e[t]??[],a=i.filter(t=>t.problem).length,o=i.filter(t=>t.low_battery).length;return j`
              ...
              `})}
          ${Object.entries(Ot).filter(([e])=>t.sources_enabled[e]??!0).map(([e,s])=>{const i=t.integrations.filter(t=>t.domain===e),a=i.some(t=>t.installed),o=i.some(t=>t.installed&&"loaded"!==t.state);return j`
                <div class="security-source-tile">
                  <div class="label">${s}</div>
                  <div
                    class="value"
